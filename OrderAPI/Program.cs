...
// let's test the build and push image to acr github pipeline
...
{
    options.AddPolicy("OrderApiCaller", policy =>
    {
        policy.RequireAuthenticatedUser();
        policy.RequireRole(builder.Configuration["Authorization:OrderApiAccessRole"] ?? "OrderApi.Access");
    });
});
